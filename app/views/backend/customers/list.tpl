<div class="nano">
  <div class="nano-content">
    <div class="column-title cl-f c-pdg-h c-pdg-t c-pdg-bas-b">
      <h3 class="f-ttl c-blk fl-l">Customers</h3>
    ...
    <div class="scrll-stck">
      <form class="scrll-stck-cnt c-pdg-h c-pdg-bas-v -sticky">
        <p class="input-search-holder">
          <input type="search" class="form-input input-search" placeholder="Search by name, date">
        </p>
      </form><!-- /.scrll-stck-cnt -->
    </div><!-- /.scrll-stck -->
    <ul class="cln-lst c-pdg-bas-t" id="customers-list">
