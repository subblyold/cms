...
<head>
  ...
  <script src="<?= URL::to('/public/backend/assets/lib/modernizr.js'); ?>"></script>

  <link rel="stylesheet" href="<?= URL::to('/public/backend/assets/css/subbly.development.css'); ?>">
  <style>
  </style>
  ...
  <div class="container">
    <section class="main-nav">
      <a href="javascript:;" class="main-logo js-trigger-go-home">
         <img class src="<?= URL::to('/public/backend/assets/img/subbly-logo.svg'); ?>" width="100" alt="logo Subbly">
      </a>
